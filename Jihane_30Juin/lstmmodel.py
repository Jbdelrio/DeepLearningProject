...
#todo : Définition du modèle LSTM
class LSTMModel(nn.Module):
    def __init__(self, input_size=1, hidden_layer_size=50, num_layers=2, output_size=1):
        #todo : Appel au constructeur de la classe parente nn.Module
        ...
        #todo :  Définition de la couche LSTM
        # avec l'input size (taille des caractéristiques d'entrée) et
        # l'hidden_layer_size (nombre de neurones dans la couche cachée)
        self.lstm = nn.LSTM(input_size, hidden_layer_size, num_layers, batch_first=True)
        
        #todo : Définition de la couche linéaire
        # avec l'hidden_layer_size: taille de l'entrée
        # et l'output_size: taille de la sortie
